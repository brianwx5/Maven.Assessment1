...
public class StringUtils {
    ...
    public static String reverseFirstWord(String sentence) {
        String[] newArray = sentence.split(" ");
        StringBuilder stringBuilders = new StringBuilder(newArray[0]);
        String result = stringBuilders.reverse().toString();
        return result;
    }
    ...
    public static String reverseFirstWordThenCamelCase(String sentence) {
        ...
        StringBuilder stringBuilders = new StringBuilder(newArray[0]);
        String result = stringBuilders.reverse().toString();
        String results = result.substring(0,1).toUpperCase() + result.substring(1);
        return results;
    }
    ...
    String result = stringBuilder.deleteCharAt(index).toString();
    return result;
    }
